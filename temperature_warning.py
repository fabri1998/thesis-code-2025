...
MQTT_PORT = 8883  
MQTT_TOPIC_WARNING = "1703/obj/generated/simulate/temperature/warning" 

# Autentiseringsuppgifter
MQTT_USER = "random"  
MQTT_PASSWORD = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" 
...
try:
    while True:
        ...
        # Bestäm om temperaturen är för hög (state_warning = 1, annars 0)
        warning_status = 1 if temperature > TEMP_THRESHOLD else 0
        ...
        print(f"Skickade varningsstatus: {warning_status} (Temperatur: {temperature}°C)")
